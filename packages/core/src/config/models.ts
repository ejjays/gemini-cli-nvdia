...
export const DEEPSEEK_V4_FLASH = 'deepseek-ai/deepseek-v4-flash';
export const DEEPSEEK_V4_PRO = 'deepseek-ai/deepseek-v4-pro';
...
export function getDisplayString(
  ...
  switch (model) {
    ...
    case DEEPSEEK_V4_FLASH:
      return 'DeepSeek v4 Flash (NVIDIA)';
    case DEEPSEEK_V4_PRO:
      return 'DeepSeek v4 Pro (NVIDIA)';
    case GEMINI_MODEL_ALIAS_PRO:
