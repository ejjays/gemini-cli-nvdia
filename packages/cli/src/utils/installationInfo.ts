...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @mmmbuto/gemini-cli-termux@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @mmmbuto/gemini-cli-termux@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @mmmbuto/gemini-cli-termux@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @mmmbuto/gemini-cli-termux@latest';
    return {
